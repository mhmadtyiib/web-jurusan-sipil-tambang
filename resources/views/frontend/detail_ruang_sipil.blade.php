    ...
    <section class="case-single-section">
    	<div class="auto-container">
            ...
            <div class="upper-box">
            	<div class="row clearfix">
                    ...
                    <div class="image-column col-md-8 col-sm-12 col-xs-12">
                    	<div class="image">
                        	<img src="{{url("public/$ruang_manajemen_sipil->foto")}}" style="object-fit: cover; position: static; width: 300%; height: 500px;"/>
                        </div>
                    </div>
            ...
            <div class="description-box">
                ...
                <div class="text">{{$ruang_manajemen_sipil->deskripsi}}</div>
                <div class="row clearfix">
