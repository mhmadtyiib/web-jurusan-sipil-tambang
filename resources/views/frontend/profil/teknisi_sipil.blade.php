    ...
    <div class="auto-container">
        <div class="inner-container">
            ...
            <div class="sec-title centered">
                <div class="title"></div>
                <h2> Teknisi <br> <br>Jurusan Teknik Sipil dan Pertambangan <br> Program Studi Teknologi Rekayasa Konstruksi Jalan dan Jembatan</h2>
            </div>
                ...
                <div class="services-page-section">
                    <div class="auto-container">
                        <div class="row clearfix">
                            ...
                            <!--Services Block Four-->
                            @foreach ($list_teknisi_sipil as $teknisi_sipil)
                            <div class="services-block-four col-md-4 col-sm-6 col-xs-12">
                                <div class="inner-box">
                                    <div class="image">
                                        <img src="{{url("public/$teknisi_sipil->foto")}}" style="object-fit: cover; position: static; width: 100%; height: 400px;" />
                                    ...
                                    <div class="lower-content">
                                        ...
                                        <div style="text-align: center; color:gray; text-transform: uppercase">
                                            {{$teknisi_sipil->jabatan}}
                                        </div>
                                        <div style="text-align: center; color:black; text-transform: uppercase">
                                            NIDN : {{$teknisi_sipil->nidn}} <br> NIP : {{$teknisi_sipil->nip}}
                                        </div>
                                    </div>
                                </div>
                            </div>
